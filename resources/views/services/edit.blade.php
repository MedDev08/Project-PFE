        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="d-flex align-items-center">
                    <h4 class="card-title">Edist Service</h4>
                </div>
            </div>
            <div class="card-body">
            <form action="{{route('services.update',$service)}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                @csrf
                @method('PUT')
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea name="description" id="textarea-input" rows="9" placeholder="Content..." class="form-control">{{$service->description}}</textarea>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <img width="100px" src="{{asset('storage/'.$service->img)}}" alt="">
                    </div>
                </div>
